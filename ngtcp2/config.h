...
/* #undef ENABLE_EXAMPLE_BORINGSSL */

/* Define to 1 in order to build examples/{gtlsclient,gtlsserver} */
/* #undef ENABLE_EXAMPLE_GNUTLS */

/* Define to 1 in order to build examples/{ptlsclient,ptlsserver} */
/* #undef ENABLE_EXAMPLE_PICOTLS */

/* Define to 1 in order to build examples/{qtlsclient,qtlsserver} */
#define ENABLE_EXAMPLE_QUICTLS 1
...
/* Define to 1 to disable memory pool. */
/* #undef NOMEMPOOL */

/* Name of package */
#define PACKAGE "ngtcp2"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "t-tujikawa@users.sourceforge.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ngtcp2"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ngtcp2 1.1.0-DEV"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ngtcp2"
